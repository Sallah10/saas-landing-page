  ...
  return (
    <section id='testimonials'>
      <div className='flex flex-col items-center gap-8 mb-10'>
        ...
        <p className='text-p'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique possimus qui dicta voluptatum distinctio ratione.</p>
      </div>
      ...
      <div className="card items-center w-[100%] h-[500px] justify-center gap-12 bg-gradient-to-bl from-[#3a1e64] to-[#060B27] my-16 rounded-xl bg-[url('/assets/Bg shape.png')] ">
        <Image src={discord} alt='discord'/>
        <h2 className='text-H2 text-white'> Join the community</h2>
        <p className='text-p w-[700px] text-center'> Join our 400,000+ person community and contribute to a more private and decentralized internet. Start for free.</p>
