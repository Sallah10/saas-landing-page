...
const features = () => {
  return (
    <section className='flex flex-col gap-12 my-16 mt-8 md:justify-center md:items-center max-w-screen' id='features'>
      <h2 className='text-H3 lg:text-H2 flex justify-center text-center'> Essential apps that protect your </h2>
      ...
      <div className='flex flex-col justify-between md:justify-center md:items-center gap-10 p-10 border-slate-500 border-2 bg-gradient-to-bl from-[#201320] to-[#060B27] '>
        <div className='flex flex-col gap-6'>
          <h2 className='text-H3 lg:text-H2 px-4 text-center'> End-to-end encrypted inbox and messages</h2>
          <p className='text-p text-justify px-20'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis totam laboriosam amet porro minima iste sed quam.</p>
      ...
      <div>
        ...
        {/* max-w-[700px] */}
          <div className='flex flex-col gap-4 md:gap-6 p-16 bg-gradient-to-bl from-[#3a1e64] to-[#060B27]'>
            <Image src={featurePhone} alt="featuresphone" className=' flex self-center' />
            <h2 className='md:text-H2 text-H3 flex self-center'>Mobile applications</h2>
          ...
          {/* max-w-[800px]  */}
          <div className='flex flex-col gap-10 lg:gap-4 p-8 md:justify-center md:items-center  text-center bg-gradient-to-bl from-[#746191] to-[#060B27]'>
            <h2 className='text-H3 lg:text-H2'>Update share, and preview any file</h2>
            <p className='text-p text-justify mb-4'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Lvoluptas, debitis aliquam beatae impedit. Porro!</p>
      ...
      <div className='mt-8 p-6 bg-gradient-to-bl from-[#201320] to-[#060B27]'>
        <div className='flex flex-col justify-between  md:items-center  mb-14'>
            {/* max-w-[700px] */}
          <div className=' flex flex-col gap-10 my-16 '>
            <h2 className='text-H3 text-center lg:text-H2'> Transparent, audited, &open source</h2>
            <p className='text-p text-justify lg:px-12'> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Perspiciatis facere porro obcaecati. Delectus ducimus cumque, omnis exercitationem minus quo illo nemo corrupti aspernatur tempora corporis? Iure unde quibusdam nostrum commodi?</p>
        ...
        <div className='flex flex-col gap-16 md:items-center'>
          <div className='flex flex-col gap-6 p-10 bg-gradient-to-bl from-[#3a1e64] to-[#060B27] max-w-[900px] rounded-2xl'>
            <h3 className='text-H3 lg:text-H2'> Product Mail</h3>
            ...
            <div>
              ...
              <h3 className='text-xl flex gap-4 my-6 items-center'> From <span className=''>Muhammed@gmail.com</span></h3> <hr />
              <h3 className='text-xl mt-6 -mb-10'> Gilisis </h3>
            </div>
          </div>
          <div className='flex flex-col gap-6 p-10 bg-gradient-to-bl from-[#3a1e64] to-[#060B27] max-w-[900px] rounded-2xl'>
            <h3 className='text-H3 lg:text-H2'>Product UI</h3>
